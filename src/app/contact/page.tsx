...
import { Mail, ArrowRight, CheckCircle2, Linkedin, Clock } from "lucide-react";
            ...
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                <div className="mb-16 text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-[var(--text-secondary)] leading-relaxed">
                        Interim opdracht? Adviesvraag? Of wil je gewoon even sparren over jouw datasituatie? Neem direct contact op.
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
                            ...
                            {isSubmitted ? (
                                <div className="flex flex-col items-center justify-center h-80 text-center animate-in fade-in zoom-in duration-500">
                                    ...
                                    <p className="text-[var(--text-secondary)] max-w-md mx-auto">
                                        Bedankt voor je interesse! Ik neem zo snel mogelijk contact met je op om de mogelijkheden te bespreken.
                                    </p>
                                    <button
                                        onClick={() => setIsSubmitted(false)}
                                        className="mt-8 text-[var(--accent)] hover:text-[var(--text-primary)] transition-colors"
                                    >
                                ...
                                <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            required
                                            rows={6}
                                            className="w-full bg-[var(--surface)] border border-[var(--border)] rounded-lg px-4 py-3 text-[var(--text-primary)] focus:outline-none focus:border-[var(--accent)] transition-colors resize-none"
                                            placeholder="Typ hier jouw vraag of omschrijf de opdracht..."
                                        />
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="btn-primary w-full py-4 text-lg font-medium flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                                    >
                    ...
                    <div className="w-full lg:w-2/5 flex flex-col gap-8">
                        ...
                        <div className="glass-card p-8 rounded-2xl flex items-start gap-4 hover:border-[var(--accent)] transition-colors group cursor-pointer" onClick={() => window.location.href = "mailto:info@powerbistudio.nl"}>
                            <div className="w-12 h-12 bg-[rgba(59,130,246,0.1)] rounded-full flex items-center justify-center shrink-0 border border-[rgba(59,130,246,0.2)] group-hover:bg-[var(--accent)] transition-colors">
                                <Mail size={24} className="text-[var(--accent)] group-hover:text-[var(--text-primary)]" />
                            </div>
                            <div>
                                <h3 className="text-xl font-display font-medium text-[var(--text-primary)] mb-2">E-mail</h3>
                                <p className="text-[var(--text-secondary)]">
                                    Stuur direct een mail voor korte vragen of bijlagen.
                                </p>
                                <a href="mailto:info@powerbistudio.nl" className="inline-block mt-3 text-[var(--accent)] font-medium hover:underline">
                        ...
                        <div className="glass-card p-8 rounded-2xl flex items-start gap-4 hover:border-[#0077b5] transition-colors group cursor-pointer" onClick={() => window.open("https://www.linkedin.com/in/jan-willem-den-hollander/", "_blank")}>
                            <div className="w-12 h-12 bg-[rgba(0,119,181,0.1)] rounded-full flex items-center justify-center shrink-0 border border-[rgba(0,119,181,0.2)] group-hover:bg-[#0077b5] transition-colors">
                                <Linkedin size={24} className="text-[#0077b5] group-hover:text-[var(--text-primary)]" />
                            </div>
                            <div>
                                <h3 className="text-xl font-display font-medium text-[var(--text-primary)] mb-2">LinkedIn</h3>
                                <p className="text-[var(--text-secondary)]">
                                    Volg mij voor updates over Power BI, DAX tips en praktijkcases.
                                </p>
                                <a href="https://www.linkedin.com/in/jan-willem-den-hollander/" target="_blank" rel="noreferrer" className="inline-block mt-3 text-[#0077b5] font-medium hover:underline">
                                    Bekijk profiel
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="glass-card p-8 rounded-2xl flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[var(--text-secondary)]">
                                    Momenteel beschikbaar voor (interim) opdrachten en adviesgesprekken.
                                </p>
                            </div>
                        </div>
